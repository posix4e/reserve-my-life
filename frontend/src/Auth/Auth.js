...
export default class Auth {
  ...
  login() {
    this.auth0.authorize({nonce: this.noncesensence});
  }

  handleAuthentication() {
    this.auth0.parseHash({nonce: this.noncesensence}, (err, authResult) => {
